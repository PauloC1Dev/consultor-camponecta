      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/10 p-8 space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm">Entre na sua conta para continuar</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center px-4 py-3 border border-white/10 rounded-xl bg-white/5 hover:bg-white/10 text-white transition-all duration-200 group">
        ...
        <div className="text-center mt-6">
          <p className="text-gray-500 text-xs">
            ...
            <a href="#" className="text-purple-400 hover:text-purple-300 transition-colors">Termos de Serviço</a>
            {' '}e{' '}
            <a href="#" className="text-purple-400 hover:text-purple-300 transition-colors">Política de Privacidade</a>
          </p>
        </div>
      </div>
    </div>
